...
export default function PartnersComponent() {
  const partners = [
    ...
    },
    {
      ...
      description:
        "Компания ПРЕМЬЕР производит полиграфическое оборудование для трафаретной печати (шелкографии). ПРЕМЬЕР готов предложить комплексные решения по организации участков трафаретной печати.",
    },
  ];
  return (
